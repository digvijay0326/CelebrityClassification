...
from ImageClassifier.pipeline.stage_02_prepare_base_model import PrepareBaseModelTraingingPipeline
from ImageClassifier.pipeline.stage_03_training import ModelTrainingPipeline
from ImageClassifier.pipeline.stage_04_evaluation import ModelEvaluation
...
try: 
   logger.info(f"*******************")
   logger.info(f">>>>>> stage {STAGE_NAME} started <<<<<<")
   prepare_base_model = PrepareBaseModelTraingingPipeline()
